...
typedef struct {
    ...
    PetscErrorCode      (*FracDUpDatePcow)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
    PetscErrorCode      (*FracDUpDatePcog)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
} FracDCapPress;
...
typedef struct {
    ...
    PetscErrorCode      (*FracDUpDateKrw)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
    PetscErrorCode      (*FracDUpDateKro)(PetscReal*, PetscReal, PetscReal, PetscReal**, PetscReal**, PetscReal**, PetscReal*, PetscInt, PetscInt);
    PetscErrorCode      (*FracDUpDateKrg)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
} FracDRelPerm;
...
typedef struct {
    ...
    PetscErrorCode       (*FracDUpDateFVF)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
    PetscErrorCode       (*FracDUpDateViscosity)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
    PetscErrorCode       (*FracDUpDateDensity)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
} FracDPVT;
...
typedef struct {
    ...
    PetscInt             numdatarow;                         /* Number of rows of data in input table */
    char                 datafilename[PETSC_MAX_PATH_LEN];
    PetscErrorCode       (*FracDUpDateSolutionGasOilRatio)(PetscReal*, PetscReal, PetscReal**, PetscReal*, PetscInt);
} FracDPbRs;
