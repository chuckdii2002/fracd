...
//    printf("\n\n\n\n INSIDE DRg_dp\n\n\n\n\n");
    ...
    for(c = cStart; c < cEnd; ++c){
        ...
        for(k = 0; k < numclpts; k++){
            ...
            if(pt >= gStart && pt < gEnd){
                ...
                bag->ppties.SolutionGasOilData.ModelData[2] = bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = fbubblepress;
                ...
                ierr = FracDQuantityAndDerivativeComputation(BoData,fpress,bag->SMALL_PRESSURE,PETSC_NULL,bag->ppties.OilPVTData.B_TableData,bag->ppties.OilPVTData.B_ModelData,bag->ppties.OilPVTData.numdatarow,bag->ppties.OilPVTData.FracDUpDateFVF);CHKERRQ(ierr);
                ierr = FracDQuantityAndDerivativeComputation(muoData,fpress,bag->SMALL_PRESSURE,PETSC_NULL,bag->ppties.OilPVTData.mu_TableData,bag->ppties.OilPVTData.mu_ModelData,bag->ppties.OilPVTData.numdatarow,bag->ppties.OilPVTData.FracDUpDateViscosity);CHKERRQ(ierr);
        ...
        for(i = 0; i < bag->CVFEface.elemnodes; i++){
            bag->ppties.SolutionGasOilData.ModelData[2] = bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = Pb_array[i];
            ierr = FracDQuantityAndDerivativeComputation(BoData,P_array[i],bag->SMALL_PRESSURE,PETSC_NULL,bag->ppties.OilPVTData.B_TableData,bag->ppties.OilPVTData.B_ModelData,bag->ppties.OilPVTData.numdatarow,bag->ppties.OilPVTData.FracDUpDateFVF);CHKERRQ(ierr);
            Bo = BoData[0]; invBo_derv = BoData[2];
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            ierr = FracDQg(&Qg,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDQg(&Qg1,bag->well[w],G,Pbh_array[w],P_array[l]+bag->SMALL_PRESSURE,Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
...
//    printf("\n\n\n\n INSIDE DRg_Sw\n\n\n\n\n");
    ...
    for(c = cStart; c < cEnd; ++c){
        ...
        for(k = 0; k < numclpts; k++){
            ...
            if(pt >= gStart && pt < gEnd){
                ...
                ierr = bag->ppties.OilPVTData.FracDUpDateFVF(&Bo,fpress,PETSC_NULL,bag->ppties.OilPVTData.B_TableData,bag->ppties.OilPVTData.B_ModelData,bag->ppties.OilPVTData.numdatarow);CHKERRQ(ierr);
        ...
        for(i = 0; i < bag->CVFEface.elemnodes; i++){
            bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = Pb_array[i];
            ierr = bag->ppties.OilPVTData.FracDUpDateFVF(&Bo,P_array[i],PETSC_NULL,bag->ppties.OilPVTData.B_TableData,bag->ppties.OilPVTData.B_ModelData,bag->ppties.OilPVTData.numdatarow);CHKERRQ(ierr);
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQg(&Qg,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDQg(&Qg1,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l]+bag->SMALL_SATURATION,Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
...
//    printf("\n\n\n\n INSIDE DRg_dSg\n\n\n\n\n");
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQg(&Qg,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDQg(&Qg1,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l]+bag->SMALL_SATURATION,Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            dervQg = (Qg1-Qg)/(bag->SMALL_SATURATION);
            matvalue =  -1. * theta * bag->epD.phi[l] * dervQg;
            ierr = MatSetValues(K, 1, &cols[l], 1, &cols[l], &matvalue, ADD_VALUES);CHKERRQ(ierr);
            if (KPC != K) {
...
//    printf("\n\n\n\n INSIDE DRg_dpbh\n\n\n\n\n");
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQg(&Qg,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDQg(&Qg1,bag->well[w],G,Pbh_array[w]+bag->SMALL_PRESSURE,P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            dervQg = (Qg1-Qg)/(bag->SMALL_SATURATION);
...
extern PetscErrorCode FracDRg(void *user, Vec Rg, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(c = cStart; c < cEnd; ++c){
        ...
        for(k = 0; k < numclpts; k++){
            ...
            if(pt >= gStart && pt < gEnd){
                ...
                bag->ppties.SolutionGasOilData.ModelData[2] = bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = fbubblepress_o;
        ...
        for(i = 0; i < bag->CVFEface.elemnodes; i++){
            ...
            bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = oPb_array[i];
            ierr = bag->ppties.OilPVTData.FracDUpDateFVF(&Bo_o,oP_array[i],PETSC_NULL,bag->ppties.OilPVTData.B_TableData,bag->ppties.OilPVTData.B_ModelData,bag->ppties.OilPVTData.numdatarow);CHKERRQ(ierr);
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQg(&Qg,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = oPb_array[l];
            ierr = FracDQg(&Qg_o,bag->well[w],G,oPbh_array[w],oP_array[l],oSw_array[l],oSg_array[l],oPcow_array[l],oPcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
