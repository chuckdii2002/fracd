    ...
    for(c = cStart; c < cEnd; ++c){
        ...
        for(k = 0; k < numclpts; k++){
            ...
            if(pt >= gStart && pt < gEnd){
                ...
                bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = fbubblepress;
...
//                lambda = kro/(muo*Bo);
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            ierr = FracDQo(&Qo,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQo(&Qo1,bag->well[w],G,Pbh_array[w],P_array[l]+bag->SMALL_PRESSURE,Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
...
extern PetscErrorCode FracDdRo_dSw(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQo(&Qo,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQo(&Qo1,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l]+bag->SMALL_SATURATION,Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
...
extern PetscErrorCode FracDdRo_dSg(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQo(&Qo,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQo(&Qo1,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l]+bag->SMALL_SATURATION,Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            dervQo = (Qo1-Qo)/(bag->SMALL_SATURATION);
            matvalue =  -1. * theta * bag->epD.phi[l] * dervQo;
            ierr = MatSetValues(K, 1, &cols[l], 1, &cols[l], &matvalue, ADD_VALUES);CHKERRQ(ierr);
            if (KPC != K) {
...
extern PetscErrorCode FracDdRo_dPbh(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQo(&Qo,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQo(&Qo1,bag->well[w],G,Pbh_array[w]+bag->SMALL_PRESSURE,P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            dervQo = (Qo1-Qo)/(bag->SMALL_SATURATION);
...
extern PetscErrorCode FracDRo(void *user, Vec Ro, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(c = cStart; c < cEnd; ++c){
        ...
        for(k = 0; k < numclpts; k++){
            ...
            if(pt >= gStart && pt < gEnd){
                ...
                bag->ppties.OilPVTData.B_ModelData[2] = bag->ppties.OilPVTData.rho_ModelData[2] = bag->ppties.OilPVTData.mu_ModelData[2] = fbubblepress_o;
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            ierr = FracDQo(&Qo_o,bag->well[w],G,oPbh_array[w],oP_array[l],oSw_array[l],oSg_array[l],oPcow_array[l],oPcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
