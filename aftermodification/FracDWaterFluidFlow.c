...
//        for(c = 17; c < 18; ++c){
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            ierr = FracDQw(&Qw,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQw(&Qw1,bag->well[w],G,Pbh_array[w],P_array[l]+bag->SMALL_PRESSURE,Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
...
extern PetscErrorCode FracDdRw_dSw(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQw(&Qw,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQw(&Qw1,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l]+bag->SMALL_SATURATION,Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
...
extern PetscErrorCode FracDdRw_dPbh(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQw(&Qw,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQw(&Qw1,bag->well[w],G,Pbh_array[w]+bag->SMALL_PRESSURE,P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            dervQw = (Qw1-Qw)/bag->SMALL_PRESSURE;
...
extern PetscErrorCode FracDRw(void *user, Vec Rw, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    PetscInt       *closurept=NULL,*rclosurept=NULL,*rclosurept1=NULL;
    PetscReal      *cellcentroid,*edgecentroid,**facecentroid,**CVfacecoords,*wellcoords;;
    Vec            localResidual,localP,localPb,localoP,localPcow,localoPcow,localPcog,localoPcog,localSw,localoSw,localSg,localoSg,localPbh,localoPbh,localQP;
    ...
    PetscScalar    *oP_array=NULL,*oPcow_array=NULL,*oPcog_array=NULL,*oSw_array=NULL,*oSg_array=NULL,*oPbh_array=NULL;
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDQw(&Qw,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
            ierr = FracDQw(&Qw_o,bag->well[w],G,oPbh_array[w],oP_array[l],oSw_array[l],oSg_array[l],oPcow_array[l],oPcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData);CHKERRQ(ierr);
