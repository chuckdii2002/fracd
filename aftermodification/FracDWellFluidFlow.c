...
extern PetscErrorCode FracDdRpbh_dP(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            ierr = FracDWellModel(&R,&Qs,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDWellModel(&R1,&Qs,bag->well[w],G,Pbh_array[w],P_array[l]+bag->SMALL_PRESSURE,Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
...
extern PetscErrorCode FracDdRpbh_dSw(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDWellModel(&R,&Qs,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDWellModel(&R1,&Qs,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l]+bag->SMALL_SATURATION,Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
        ...
        for(w = 0; w < bag->numWells; w++){
            ...
            if( PetscAbs(1.0-Volumecheck) < PETSC_SMALL){
                ...
                for(l = 0; l < bag->CVFEface.elemnodes; l++){
                    ...
                    G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
                    ierr = FracDWellModel(&R,&Qs,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
                    ierr = FracDWellModel(&R1,&Qs,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l]+bag->SMALL_SATURATION,Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
                    dervR = (R1-R)/(bag->SMALL_SATURATION);
                    matvalue[l] =  bag->epD.phi[l] * dervR;
//                    
//                    if(c == 1759 || c == 1194){
...
extern PetscErrorCode FracDdRpbh_dPbh(void *user, Mat K, Mat KPC, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            G = 2*PETSC_PI*CFbeta*effectiveCellPerm*bag->well[w].h/(PetscLogReal(bag->well[w].re/bag->well[w].rw)+bag->well[w].sk);
            ierr = FracDWellModel(&R,&Qs,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            ierr = FracDWellModel(&R1,&Qs,bag->well[w],G,Pbh_array[w]+bag->SMALL_PRESSURE,P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
            dervR = (R1-R)/(bag->SMALL_PRESSURE);
...
extern PetscErrorCode FracDRpbh(void *user, Vec RPbh, Vec P, Vec Sw, Vec Sg, Vec Pbh)
{
    ...
    for(i = 0; i < bag->WellinMeshData.numberWellsInProcessor; i++) {
        ...
        for(l = 0; l < bag->CVFEface.elemnodes; l++){
            ...
            ierr = FracDWellModelRates(&Qw,&Qo,&Qg,bag->well[w],G,Pbh_array[w],P_array[l],Sw_array[l],Sg_array[l],Pcow_array[l],Pcog_array[l],bag->ppties.WaterPVTData,bag->ppties.OilPVTData,bag->ppties.GasPVTData,bag->ppties.RelPermData,bag->ppties.SolutionGasOilData);CHKERRQ(ierr);
...
extern PetscErrorCode FracDWellModel(PetscReal *Q,PetscReal *Qconstr,FracDWell well,PetscReal G,PetscReal Pbh,PetscReal P,PetscReal Sw,PetscReal Sg,PetscReal Pcow,PetscReal Pcog,FracDPVT WaterPVTData,FracDPVT OilPVTData,FracDPVT GasPVTData,FracDRelPerm RelPermData,FracDPbRs SolutionGasOilData)
{
    PetscErrorCode ierr;
...
extern PetscErrorCode FracDQw(PetscReal *Qw,FracDWell well,PetscReal G,PetscReal Pbh,PetscReal P,PetscReal Sw,PetscReal Sg,PetscReal Pcow,PetscReal Pcog,FracDPVT WaterPVTData,FracDPVT OilPVTData,FracDPVT GasPVTData,FracDRelPerm RelPermData)
{
    PetscErrorCode ierr;
    PetscReal      Bw,muw,krw;
...
extern PetscErrorCode FracDQo(PetscReal *Qo,FracDWell well,PetscReal G,PetscReal Pbh,PetscReal P,PetscReal Sw,PetscReal Sg,PetscReal Pcow,PetscReal Pcog,FracDPVT WaterPVTData,FracDPVT OilPVTData,FracDPVT GasPVTData,FracDRelPerm RelPermData)
{
    PetscErrorCode ierr;
    PetscReal      Bw,muw,krw;
    PetscReal      Bo,muo,kro;
...
extern PetscErrorCode FracDQg(PetscReal *Qg,FracDWell well,PetscReal G,PetscReal Pbh,PetscReal P,PetscReal Sw,PetscReal Sg,PetscReal Pcow,PetscReal Pcog,FracDPVT WaterPVTData,FracDPVT OilPVTData,FracDPVT GasPVTData,FracDRelPerm RelPermData,FracDPbRs SolutionGasOilData)
{
    PetscErrorCode ierr;
    PetscReal      Bw,muw,krw;
...
extern PetscErrorCode FracDWellModelRates(PetscReal *Qw,PetscReal *Qo,PetscReal *Qg,FracDWell well,PetscReal G,PetscReal Pbh,PetscReal P,PetscReal Sw,PetscReal Sg,PetscReal Pcow,PetscReal Pcog,FracDPVT WaterPVTData,FracDPVT OilPVTData,FracDPVT GasPVTData,FracDRelPerm RelPermData,FracDPbRs SolutionGasOilData)
{
    PetscErrorCode ierr;
    PetscReal      Bw,muw,krw;
    PetscReal      Bo,muo,kro,Rs;
